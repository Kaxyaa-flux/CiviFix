  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-3xl max-h-[90vh] bg-slate-50 dark:bg-transparent rounded-2xl shadow-2xl border border-white/10 overflow-y-auto z-10"
      >
        {/* Header */}
        <div className="sticky top-0 bg-slate-50 dark:bg-transparent border-b border-white/10 px-6 py-4 flex items-center justify-between z-10">
          <div className="flex items-center gap-2">
            <div className="p-1.5 bg-blue-100 dark:bg-blue-900/30 text-[#7C3AED] rounded-lg">
              <Sparkles className="w-5 h-5" />
            </div>
            <h2 className="font-display font-bold text-xl text-slate-950 dark:text-slate-900 dark:text-white">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-[#16161D]/90 backdrop-blur-md dark:bg-[#16161D]/90/50 rounded-xl p-4 border border-slate-200/60 dark:border-white/10/60">
            <div className="flex items-center gap-2 text-xs font-semibold text-[#7C3AED] dark:text-blue-400 mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5">
              {PRESETS.map((preset, idx) => (
                <button
                  ...
                  className="text-left px-3 py-2 text-xs bg-[#16161D]/90 backdrop-blur-md dark:bg-slate-800 hover:bg-blue-50 dark:hover:bg-slate-700/50 border border-slate-200 dark:border-slate-700 rounded-lg transition-all line-clamp-2 shadow-xs cursor-pointer hover:border-blue-400"
                >
                  <span className="font-medium text-slate-900 dark:text-slate-900 dark:text-white block truncate">{preset.title}</span>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-[#16161D]/90 backdrop-blur-md dark:bg-[#16161D]/90 border border-white/10 focus:border-white/10 dark:focus:border-white/10 rounded-xl text-slate-900 dark:text-slate-900 dark:text-white text-sm outline-none transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 bg-[#16161D]/90 backdrop-blur-md dark:bg-[#16161D]/90 border border-white/10 focus:border-white/10 dark:focus:border-white/10 rounded-xl text-slate-900 dark:text-slate-900 dark:text-white text-sm outline-none transition-all resize-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 bg-[#16161D]/90 backdrop-blur-md dark:bg-[#16161D]/90 border border-white/10 focus:border-white/10 dark:focus:border-white/10 rounded-xl text-slate-900 dark:text-slate-900 dark:text-white text-sm outline-none transition-all"
                    />
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div
                    ...
                    className={`border-2 border-dashed rounded-xl p-6 flex flex-col items-center justify-center transition-all cursor-pointer ${
                      fileAdded 
                        ? 'border-green-500 bg-emerald-50/20 dark:bg-emerald-950/10' 
                        : 'border-slate-300 dark:border-white/10 hover:border-white/10 dark:hover:border-white/10 bg-[#16161D]/90 backdrop-blur-md/50 dark:bg-[#16161D]/90/30'
                    }`}
                    onClick={() => {
                      setFileAdded(true);
                  ...
                  >
                    <UploadCloud className={`w-8 h-8 mb-2 ${fileAdded ? 'text-green-500' : 'text-slate-400'}`} />
                    {fileAdded ? (
                      <div className="text-center">
                        <span className="text-sm font-semibold text-emerald-600 dark:text-green-400 block">
                ...
                <div className="flex-1 flex flex-col justify-end">
                  ...
                  {!aiAnalysisResult && !isAnalyzing && (
                    <button
                      ...
                      className="w-full py-3 px-4 bg-slate-900 hover:bg-slate-800 dark:bg-[#7C3AED] dark:hover:bg-[#7C3AED] text-slate-900 dark:text-white font-sans text-sm font-medium rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-[#051F20]/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                    >
                  ...
                  {isAnalyzing && (
                    <div className="bg-blue-50/80 dark:bg-blue-950/20 border border-blue-200/50 dark:border-blue-800/40 rounded-xl p-4 space-y-3">
                      <div className="flex items-center justify-between text-xs font-semibold text-[#7C3AED] dark:text-blue-400">
                      ...
                      <div className="h-1.5 bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
                        <motion.div 
                          className="h-full bg-[#7C3AED] dark:bg-blue-400"
                          initial={{ width: '0%' }}
                          animate={{ 
                  ...
                  {aiAnalysisResult && (
                    ...
                    >
                      <div className="flex items-center justify-between text-xs font-bold text-emerald-600 dark:text-green-400">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs text-slate-700 dark:text-slate-300">
                        <div>
                          ...
                          <span className="font-semibold text-slate-900 dark:text-slate-900 dark:text-white">{aiAnalysisResult.detectedCategory}</span>
                        </div>
                        <div>
                          ...
                          <span className={`font-bold capitalize ${
                            ...
                            aiAnalysisResult.suggestedPriority === 'high' ? 'text-amber-500' : 'text-[#7C3AED]'
                        ...
                        <div>
                          ...
                          <span className="font-semibold text-slate-900 dark:text-slate-900 dark:text-white text-[11px] block truncate">{aiAnalysisResult.department}</span>
                        </div>
                        <div>
                          ...
                          <span className="font-semibold text-slate-900 dark:text-slate-900 dark:text-white flex items-center gap-1">
            ...
            <div className="border-t border-white/10 pt-5 flex items-center justify-between">
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-4 py-2.5 border border-white/10 text-slate-700 dark:text-slate-300 hover:bg-[#16161D]/90 backdrop-blur-md dark:hover:bg-slate-900 rounded-xl font-sans text-sm font-medium transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-5 py-2.5 bg-[#163832] hover:bg-[#0B2B26] text-slate-900 dark:text-white font-sans text-sm font-bold rounded-xl flex items-center gap-2 shadow-lg shadow-[#051F20]/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all cursor-pointer"
                >
