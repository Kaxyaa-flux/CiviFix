            ...
            >
              ...
              <div className="lg:col-span-5 p-8 sm:p-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl flex flex-col justify-between hover:shadow-xl dark:hover:shadow-blue-500/5 transition-all duration-300">
                <div className="space-y-6">
                  ...
                  <h2 className="font-display font-extrabold text-2xl sm:text-3xl text-slate-950 dark:text-white tracking-tight leading-tight">
                ...
                <div className="pt-6 flex items-center gap-3 mt-6">
                  <div className="w-10 h-10 bg-emerald-500/10 text-emerald-500 dark:text-emerald-400 rounded-xl flex items-center justify-center font-bold">
                    <Heart className="w-5 h-5" />
                  </div>
                  <div className="space-y-0.5">
                    <p className="text-xs font-bold text-slate-900 dark:text-white">Citizen-Led Governance</p>
                ...
                {aiAids.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="pt-4 flex items-center justify-between border-t border-slate-100 dark:border-slate-850 mt-4">
                    ...
                    >
                      <div className="space-y-4">
                        <div className="flex justify-between items-start">
                          <span className="text-3xl font-black font-display tracking-tight text-slate-950 dark:text-white">
                            {goal.metric}
                          </span>
        ...
        <AnimatePresence mode="popLayout">
          {(activeTab === 'all' || activeTab === 'sustainability') && (
            ...
            >
              ...
              <div className="text-center max-w-2xl mx-auto space-y-3">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200/50 dark:border-emerald-900/30 rounded-full text-xs font-semibold text-emerald-700 dark:text-emerald-400 font-mono uppercase">
                ...
                {sustainabilityInits.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="pt-6 border-t border-slate-100 dark:border-slate-850 mt-6 space-y-2">
                  ...
                  >
                    ...
                    <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                      ...
                      <div className="pt-4 border-t border-slate-100 dark:border-slate-850 flex items-center gap-3">
                        ...
                        <a href={member.github} className="text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors" aria-label="GitHub">
                          <Github className="w-4 h-4" />
                        </a>
                        <a href={`mailto:hello@example.com`} className="text-slate-400 hover:text-rose-500 transition-colors ml-auto" aria-label="Email">
