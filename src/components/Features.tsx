...
export default function Features() {
  return (
    <section 
      id="features" 
      className="relative py-24 bg-white dark:bg-[#020617] border-b border-[#E2E8F0] dark:border-[#1E293B] transition-colors duration-300"
    >
          ...
          {FEATURE_LIST.map((feature, idx) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#1E293B] rounded-2xl flex flex-col justify-between hover:shadow-xl dark:hover:shadow-blue-500/5 hover:border-[#2563EB]/50 dark:hover:border-[#2563EB]/50 transition-all duration-300"
              >
